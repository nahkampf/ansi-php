...
class Parser
{
    ...
    private $fgColorLookupANSIBBS = [
        ...
        8 => SGR::COLOR_FG_BLACK . ";1",
        9 => SGR::COLOR_FG_BLUE . ";1",
        10 => SGR::COLOR_FG_GREEN . ";1",
        11 => SGR::COLOR_FG_CYAN . ";1",
        12 => SGR::COLOR_FG_RED . ";1",
        13 => SGR::COLOR_FG_PURPLE . ";1",
        14 => SGR::COLOR_FG_YELLOW . ";1",
        15 => SGR::COLOR_FG_WHITE . ";1"
    ];
